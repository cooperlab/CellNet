...
Edge::Edge(std::string id, std::string in_node_id, std::string out_node_id): _id(id), _in_node_done(false), _in_node_id(in_node_id), _out_node_id(out_node_id), _buffer(){}
